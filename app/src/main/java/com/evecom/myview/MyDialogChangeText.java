 ...
 */
public class MyDialogChangeText extends Dialog {
     ...
     * @param context：上下文
     */
    public MyDialogChangeText(Context context,String name) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_dialog_input_text);
    ...
    public String getNewName(){
        return etNewName.getText().toString();
    }
}
